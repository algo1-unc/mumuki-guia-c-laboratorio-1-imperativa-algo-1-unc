Codifique las siguientes funciones en C. Asigne `CONSULTA true` para activar el modo consulta y asi poder encontrar valores para las variables que forman el estado:
