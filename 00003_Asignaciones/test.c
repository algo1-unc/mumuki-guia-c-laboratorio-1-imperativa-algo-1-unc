...
if (CONSULTA) {
    ...
    describe("Tests para funcion exp_1a") {
        x_student = 2;
        y_student = 5;
        x_test = 2;
        y_test = 5; 
    
        describe (genState("Test1 'exp_1a'", x_test, y_test, CONSULTA)) {
        ...
        describe (genState("Test2 'exp_1a'", x_test, y_test, CONSULTA)) {
    ...
    describe("Tests para funcion exp_1b") {
    ...
    describe("Tests para funcion exp_1c") {
